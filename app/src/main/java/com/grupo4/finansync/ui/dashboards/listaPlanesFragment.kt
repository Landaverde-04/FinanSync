 ...
 * Use the [listaPlanesFragment.newInstance] factory method to
...
class listaPlanesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_lista_planes, container, false)
    }
